      ...
      <div className="page">
        <div className="content-wrapper my-orders-page-wrapper">
          ...
          <div className="my-orders-info">
            <p className="my-order-info-title">
            ...
            <div className="order-tasks-info">
              ...
              <p>
                Выполняется: <span>9</span>
              </p>
              <p>
                Закрыто: <span>89</span>
              </p>
              <p className="order-task-active">
                В архиве: <span>38</span>
              </p>
            </div>
            <p>*Задания, где выбрали других исполнителей либо отменили</p>
          </div>
