                    ...
                    <div className="caregories-right-column">
                        <div className="categories-right-top">
                            <div className="categories-right-top-left">
                                {categoriesEnum.rightTopColumnLeft.map(
                                    (item) => (
                                        <CategoryItem
                                            width={item.width}
                                            height={item.height}
                            ...
                            <div className="categories-right-top-right">
                                {categoriesEnum.rightTopColumnRight.map(
                                    (item) => (
                                        <CategoryItem
                                            width={item.width}
                                            height={item.height}
                        ...
                        <div className="categories-right-bottom">
                            <div className="categories-right-bottom-top">
                                {categoriesEnum.rightBottomColumnTop.map(
                                    (item) => (
                                        <CategoryItem
                                            width={item.width}
                                            height={item.height}
                            ...
                            <div className="categories-right-bottom-bottom">
                                {categoriesEnum.rightBottomColumnBottom.map(
                                    (item) => (
                                        <CategoryItem
                                            width={item.width}
                                            height={item.height}
