      ...
      <div className="task-card-wrapper">
        <div className="task-performer-info">
          <div className="task-performer-image">
            <img src={taskCardPerformer} alt="card-performer" />
          </div>
        ...
        <div className="task-performer-description">
          <p className="body3">Здравствуйте! Готов выполнить ваш заказ!</p>
          <p className="body3">
            Качественно и с гарантией выполню работы по замене и монтаже
            водопровода , отопления и канализации, сантехники и электрики , опыт
            работы в данной сфере 19 лет . Работаю сам , без подсобников и
            подмастерьев, соответственно и всю ответственность за выполненную
            мною работу несу сам лично.
          </p>
        </div>
